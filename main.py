...
sp = spotipy.Spotify(auth_manager=SpotifyOAuth(username="Yuval cohen",client_id=spotify_client_id, client_secret=spotify_client_secret, redirect_uri="https://www.example.com", scope="playlist-modify-private", show_dialog=True, open_browser=True, cache_path="token.txt"))
songs_links = []
...
#     try:
#         song_link = search_results['tracks']['items'][0]['external_urls']['spotify']
